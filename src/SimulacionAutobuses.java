...
public class SimulacionAutobuses {
    ...
    private double contA = 0, contB = 0, contReparacion = 0, media = 0, horasSimuladas = 0, retrasoMedioInsp = 0,
            retrasoMedioRep = 0;
    ...
    public void run() {
        ...
        impresionEstadisticas();
    }

    // Generacion de los autobuses
    ...
    private void operacionReparacion(int i) {
        ...
        tiempoReparacion[i] = 7560 + (16200 - 7560) * ri4[i];
    ...
    private void impresionEstadisticas() {
        double porcentaje = (double) ((contA) / contReparacion);
        System.out.printf("%s", "Uso de la estacion A es: " + porcentaje);

        porcentaje = (double) ((contB) / contReparacion);
    ...
    private void media() {
        String dato;
        try {
            dato = JOptionPane.showInputDialog("Introduce la media a simular en horas");
    ...
    private void tiempoAsimular() {
        ...
        try {
            ...
            setHorasSimuladas(conversor(Double.parseDouble(tiempo)));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Introduce solo numeros");
            tiempo = JOptionPane.showInputDialog("Introduce el tiempo a simular en horas");
            setHorasSimuladas(conversor(Double.parseDouble(tiempo)));
    ...
    private double conversor(double numero) {
        ...
        // Cambiamos las horas a segundos
        // Operacion= h * 60 min *60s
        return numero * 60 * 60;
    }
    ...
    private double retrasoMediodeColaInspec() {
        ...
        return retrasoMedioInsp / contAutobuses;
    }
    ...
    private double retrasoMedioColaReparacion() {
        ...
        return retrasoMedioRep / contReparacion;
    }
